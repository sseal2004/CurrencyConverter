...
const ConverterForm = () => {
 ...
 <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-center bg-gradient-to-r from-fuchsia-500 via-pink-500 to-orange-500 text-transparent bg-clip-text drop-shadow-md mb-10 tracking-widest animate-pulse">
  <span className="text-xl sm:text-2xl md:text-5xl">💱</span> Currency Converter
</h2>
...
<div className="flex items-center justify-center gap-4 my-4">
  ...
  <div className="flex justify-center">
    <div
             className="ml-3 w-12 h-12 min-w-[48px] min-h-[48px] max-w-[48px] max-h-[48px] bg-indigo-400 hover:bg-indigo-600 rounded-full flex items-center justify-center text-white cursor-pointer shadow-md transition duration-300"
